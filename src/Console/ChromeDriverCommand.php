...
namespace LarvaCMS\WebDriver\Console;
...
class ChromeDriverCommand extends Command
{
     ...
     * @var string
     */
    protected $latestVersionUrl = 'https://npm.taobao.org/mirrors/chromedriver/LATEST_RELEASE';
     ...
     * @var string
     */
    protected $versionUrl = 'https://npm.taobao.org/mirrors/chromedriver/LATEST_RELEASE_%d';
     ...
     * @var string
     */
    protected $downloadUrl = 'https://npm.taobao.org/mirrors/chromedriver/%s/chromedriver_%s.zip';
     ...
     * @return void
     */
    protected function rename(string $binary, string $os)
    {
